...
export default function Footer() {
  return (
    <footer className="bg-ink-light border-t-2 border-ink-border py-16 px-6 md:px-12">
        ...
        <FadeIn>
          <div className="flex flex-col md:flex-row items-start justify-between gap-12 mb-14">
            <div className="max-w-xs">
              <a
                href="#"
                className="font-serif text-4xl text-parchment hover:text-gold transition-colors duration-300 block mb-2"
              >
                DeeproDraws
              </a>
              <p className="font-sans text-sm text-parchment-mute leading-relaxed">
            ...
            <div className="flex gap-16 sm:gap-20">
              <div>
                <p className="font-sans text-[9px] tracking-[0.4em] uppercase text-parchment-mute mb-4 font-semibold">
                  Connect
                </p>
          ...
          <div className="border-t-2 border-ink-border pt-7">
